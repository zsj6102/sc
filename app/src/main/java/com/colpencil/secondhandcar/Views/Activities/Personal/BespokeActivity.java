...
import com.colpencil.secondhandcar.Views.Fragments.Personal.Release.CarOrderFragment;
...
public class BespokeActivity extends ColpencilActivity {
    ...
    private class OrderViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return CarOrderFragment.newsInstance(position);
        }
