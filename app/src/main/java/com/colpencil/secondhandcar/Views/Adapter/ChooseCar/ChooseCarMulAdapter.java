 ...
 */
public class ChooseCarMulAdapter extends BaseAdapter {

    private int selectorPosition = -1;

    private Activity mActivity;
    private List<Shift> carLists;
    private LayoutInflater inflater;

    public ChooseCarMulAdapter(Activity activity, List<Shift> list){
        mActivity = activity;
        carLists = list;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        holder.checkBox.setText(carLists.get(position).getOp_name());
