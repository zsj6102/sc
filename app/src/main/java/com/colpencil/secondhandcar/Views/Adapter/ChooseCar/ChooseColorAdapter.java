...
public class ChooseColorAdapter extends BaseAdapter {
    ...
    private List<ColorClassify> carLists;
    private LayoutInflater inflater;

    public ChooseColorAdapter(Activity activity, List<ColorClassify> list){
        mActivity = activity;
        carLists = list;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = inflater.inflate(R.layout.item_choose_color, null);
        ...
        Drawable drawableLeft = mActivity.getResources().getDrawable(carLists.get(position).getResId());
        drawableLeft.setBounds(0, 0, 40, 40);
        holder.checkBox.setCompoundDrawables(drawableLeft, null, drawable, null);
        holder.checkBox.setText(carLists.get(position).getColor());
