...
public class CityListAdapter extends BaseAdapter {
    ...
    public void setSections(){
        City city = new City();
        city.setLocal_name("定位");
        city.setPinyin("0");
        mCities.add(0, city);
        letterIndexes = new HashMap<>();
        sections = new String[mCities.size()];
     ...
     * @param state
     */
    public void updateLocateState(int state, String city, int cityId){
    ...
    public int getLetterPosition(String letter){
        ...
        if(letterIndexes.size() > 0){
            integer = letterIndexes.get(letter);
        }
...
//                break;
            case 1:     //所有
                ...
                if (position >= 1){
                    final String city = mCities.get(position).getLocal_name();
    ...
    public interface OnCityClickListener{
        void onCityClick(String name, int cityId);
        void onLocateClick();
    }
}
