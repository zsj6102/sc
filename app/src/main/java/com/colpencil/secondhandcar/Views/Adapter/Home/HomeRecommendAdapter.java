...
public class HomeRecommendAdapter extends SuperAdapter<FriendRecommend> {
    ...
    public HomeRecommendAdapter(Context context, List<FriendRecommend> list, int layoutId){
